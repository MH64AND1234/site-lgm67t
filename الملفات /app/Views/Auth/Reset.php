...
body {
    ...
    align-items: center;
    background: url('/public/assets/css/vip.png') no-repeat center center fixed;
...
.form-group, .btn-submit, .register-link {
...
<div class="container">
    ...
    <?= form_open() ?>
        ...
        <button type="submit" class="btn-submit">Reset Account</button>
    <?= form_close() ?>

    <div class="register-link">
        Reset Done? <a href="<?= site_url('login') ?>">Login Here</a>
    </div>
</div>
